...
class BusinessBasedInNiControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val businessBasedInNiRoute: String = routes.BusinessBasedInNiController.onPageLoad(waypoints).url
  ...
  "BusinessBasedInNi Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual BusinessBasedInNiPage.navigate(waypoints, emptyUserAnswers, expectedAnswers).url
      }
    }
