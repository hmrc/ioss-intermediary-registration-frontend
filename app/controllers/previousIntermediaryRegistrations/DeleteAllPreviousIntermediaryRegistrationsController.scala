...
import pages.previousIntermediaryRegistrations.{DeleteAllPreviousIntermediaryRegistrationsPage, HasPreviouslyRegisteredAsIntermediaryPage}
...
class DeleteAllPreviousIntermediaryRegistrationsController @Inject()(
                                                                      override val messagesApi: MessagesApi,
                                                                      cc: AuthenticatedControllerComponents,
                                                                      formProvider: DeleteAllPreviousIntermediaryRegistrationsFormProvider,
                                                                      view: DeleteAllPreviousIntermediaryRegistrationsView
