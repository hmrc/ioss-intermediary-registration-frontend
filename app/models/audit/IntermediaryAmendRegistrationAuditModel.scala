...
case class IntermediaryAmendRegistrationAuditModel(
...
object IntermediaryAmendRegistrationAuditModel {
  ...
  def build(
             ...
             amendRegistrationResponse: Option[AmendRegistrationResponse],
             submissionResult: SubmissionResult
           )(implicit request: AuthenticatedMandatoryIntermediaryRequest[_]): IntermediaryAmendRegistrationAuditModel =
    IntermediaryAmendRegistrationAuditModel(
      registrationAuditType = registrationAuditType,
